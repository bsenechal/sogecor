    ...
    >
      ...
      >
        ...
        <div
          ...
          className="absolute inset-0 flex flex-col items-center justify-center text-center p-8 rounded-2xl bg-white border border-border/70 shadow-sm"
        >
            ...
            <ScrollReveal direction="up" delay={0.2} className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
                {environmentalImpacts.map((impact, index) => {
                  ...
                  return (
                    <ScrollReveal key={index} direction="up" delay={0.1 * index} className="h-full">
            ...
            <ScrollReveal direction="up" delay={0.2}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="hover:shadow-xl transition-all duration-300 h-full border border-border/70">
                  <CardContent className="p-6">
                    <div className="mb-6 flex items-center justify-center">
                      <img src={aiprLogo} alt="Logo AIPR" className="h-32 object-contain" />
                    </div>
                    <h4 className="text-lg font-semibold text-foreground mb-2">AIPR</h4>
                ...
                <Card className="hover:shadow-xl transition-all duration-300 h-full border border-border/70">
                  <CardContent className="p-6">
                    <div className="mb-6 flex items-center justify-center">
                      <img src={tstLogo} alt="Logo TST" className="h-32 object-contain" />
                    </div>
                    <h4 className="text-lg font-semibold text-foreground mb-2">TST</h4>
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Habilitation Travaux sous Tension (TST) pour des interventions conformes aux exigences du Comité TST.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="hover:shadow-xl transition-all duration-300 h-full border border-border/70">
                  <CardContent className="p-6">
                    <div className="mb-6 flex items-center justify-center">
                      <img src={bureauVeritasLogo} alt="Logo Bureau Veritas" className="h-32 object-contain" />
                    </div>
                    <h4 className="text-lg font-semibold text-foreground mb-2">Bureau Veritas</h4>
                    <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                <Card className="hover:shadow-xl transition-all duration-300 h-full border border-border/70">
                  <CardContent className="p-6">
                    <div className="mb-6 flex items-center justify-center">
                      <img src={adntLogo} alt="Certification ADNT 3002" className="h-32 object-contain" />
                    </div>
                    <h4 className="text-lg font-semibold text-foreground mb-2">ADNT 3002</h4>
                    <p className="text-sm text-muted-foreground leading-relaxed">
