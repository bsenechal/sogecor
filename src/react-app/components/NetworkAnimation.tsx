    ...
    const animate = (currentTime: number) => {
      ...
      setNodeStates(
        points.map((_, index) => {
          ...
          if (elapsed >= pointsDuration && elapsed < totalDuration - 80)
            return 1;
          return 0;
        }),
      );
    ...
    <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
      ...
      >
        ...
        <g className="cad-bg opacity-[0.12]">
          ...
          <polyline
            points="120,270 260,240 330,285 500,250 650,300"
            stroke="#8c8c8c"
            strokeWidth="1"
            fill="none"
          />
          <polyline
            points="850,285 980,245 1120,300 1370,260"
            stroke="#8c8c8c"
            strokeWidth="1"
            fill="none"
          />
          ...
          <text x="250" y="190" fill="#8c8c8c" fontSize="10">
            Ø200 PVC
          </text>
          <text x="250" y="205" fill="#8c8c8c" fontSize="10">
            P: 1.2%
          </text>
          <text x="1090" y="185" fill="#8c8c8c" fontSize="10">
            Ø160 PEHD
          </text>
          <text x="1090" y="200" fill="#8c8c8c" fontSize="10">
            P: 0.8%
          </text>
          <text x="510" y="330" fill="#8c8c8c" fontSize="10">
            Regard Ø1000
          </text>
        </g>
        ...
        <g>
          {points.map((point, index) => (
            <g key={index} style={{ opacity: nodeStates[index] || 0 }}>
              <circle
                cx={point[0]}
                cy={point[1]}
                r="7"
